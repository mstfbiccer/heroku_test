...
app.get('/api/getdblist',function(req,res) {
  ...
  var connection = mongoose.createConnection(
    'mongodb://mustafabicer:662866mb@ds115166.mlab.com:15166/heroku_zn0dfglw');
...
app.get('/api/setdata', function (req, res) {
  mongoose.connect('mongodb://mustafabicer:662866mb@ds115166.mlab.com:15166/heroku_zn0dfglw'+req.query.dbmdl, { useMongoClient: true, promiseLibrary: global.Promise });
